...
* Add a link to the full boleto: **ticket.image\_url**. Although it is not necessary to pay, some users prefer to have it and gives them a sense of security. [Checkout a full boleto example here](https://ibb.co/mNBc6g2)
{% endhint %}
