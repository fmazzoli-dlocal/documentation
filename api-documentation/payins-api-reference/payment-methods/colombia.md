...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Codensa</td>
      <td style="text-align:left"><code>CARD</code>
      </td>
...
```c
{
    "id": "D-4-db8d2749-9e64-4873-b715-98c3d0e3b47c",
    "amount": 10000,
    "currency": "COP",
    "payment_method_id": "BU",
    "payment_method_type": "TICKET",
    ...
    "ticket": {
        ...
        "format": "GS1",
        "number": "1717893874",
        "expiration_date": "2020-09-26T04:59:00.000+0000",
        "id": "9595950804",
        "barcode": "4150000000054244802017178938743900100009620200925",
        "company_name": "Dlocal Colombia",
        "provider_name": "Kushki",
        "provider_logo": "https://s3-eu-west-1.amazonaws.com/static-dlocal/images/providers/kushki.png",
        "image_url": "https://pay.dlocal.com/gmf-apm/payments/M-5fb670f3-39f5-48a5-a7d0-c1a35bb5d1f7",
        "currency": "COP"
    },
    "created_date": "2020-09-21T19:51:31.000+0000",
    "status": "PENDING",
    "status_detail": "The payment is pending.",
    "status_code": "100",
    "order_id": "485ba496-6a80-4a4f-baa6-566eedcb1bed",
    "notification_url": "http://conductor.sandbox.internal/robot-server/rest/generic/notification/new"
}
```
{% endtab %}
...
![Example Baloto UI built with the information in the example above.](../../../.gitbook/assets/baloto%20%281%29.png)

{% tabs %}
{% tab title="User Interface Tips:" %}
{% hint style="success" %}
**User Interface Tips:**

* Separate the **PIN \(ticket.number\)** this way: 3 digits - 3 digits - 4 digits. It is easier for users to dictate it to cashiers.
* Also, separate the **Número de Convenio: \(ticket.id\) the same way:** 3 digits - 3 digits - 4 digits. This identifies the payment beneficiary and many times helps cashiers to find the payment on their system.
* Barcode needs to have the **GS1-128** format in order to be recognized by barcode readers.
* **Currency** and **amount** should be relevant elements in the ticket. Users need to be aware of that at all times.
* Make sure that the **expiration date** is clear and visible enough. In Colombia people use the **dd/mm/yyyy** format.
* Make it clear for the user that their payment will be **credited immediately**. This brings confidence and a sense of security that helps conversion rates
...
{% tab title="Payment stores and logos" %}
{% hint style="success" %}
Include **payment stores references.** Although most users are familiarized with Baloto payment stores, it is a good idea to help those who are not used to it. In the image above you can see them. Here is a list of payment stores and its logos.

* [Baloto](https://static.dlocal.com/images/providers/kushki/baloto.png)
* [Carullia](https://static.dlocal.com/images/providers/kushki/carulla.png)
* [Colsubsidio](https://static.dlocal.com/images/providers/kushki/colsubsidio.png)
* [Con suerte](https://static.dlocal.com/images/providers/kushki/con-suerte.jpg)
* [Copenessa](https://static.dlocal.com/images/providers/kushki/coopenessa.png)
* [Edeq](https://static.dlocal.com/images/providers/kushki/edeq.png)
* [Éxito](https://static.dlocal.com/images/providers/kushki/exito.png)
* [Fullcarga](https://static.dlocal.com/images/providers/kushki/full-carga.jpeg)
* [Cerca](https://static.dlocal.com/images/providers/kushki/cerca.png)
* [JER](https://static.dlocal.com/images/providers/kushki/jer.png)
* [SuChance](https://static.dlocal.com/images/providers/kushki/su-chance.jpg)
* [Moviired](https://static.dlocal.com/images/providers/kushki/moviired.png)
* [SuperInter](https://static.dlocal.com/images/providers/kushki/super-inter.png)
* [Surti Max](https://static.dlocal.com/images/providers/kushki/surtimax.png)
* [Surti Mayorista](https://static.dlocal.com/images/providers/kushki/surti-mayorista.png)
{% endhint %}
{% endtab %}
{% endtabs %}
