...
This is the base method used to request a payout. Please **note each country may have its own additional requirements**, see below for more detailed examples.
